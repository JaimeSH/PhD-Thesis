...
%\subsection{Summary of the Parameters used in the Genetic Algorithm}
%\label{subsection:summary-of-the-parameters-used-in-the-genetic-algorithm}

%Explain that the number of iterations is explained in the next Chapter
%As this Chapter only explains the implementation; parameters that are "hard-coded"
%However, we include these parameters in here
%Or maybe move this table to Chapter 6
